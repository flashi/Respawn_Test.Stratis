...
[_unit, _lives, _delay, _respawn_point, _marker, _group, _side, _AI_unitArray,_AI_magArray, _AI_wepArray,_AI_skillArray] execVM "scripts\AI_respawn_UPS\AI_respawn_UPS.sqf";
[_unit,_marker] execVM "scripts\AI_respawn_UPS\UPS_init.sqf";
